                    ...
                    <div class="left-content-area"><!-- left content area -->
                        <div class="language-picker">
                            ...
                            <div class="currency-picker">
                                <div class="default">
                                    <div class="slang-wrap">
                                        <div class="name">دلار <i class="fas fa-angle-down"></i></div>
                                </div>
                                <ul class="all-lang">
                                        <li>
                                            <div class="slang-wrap">
                                                <div class="name">ریال </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="slang-wrap">
                                                <div class="name">یورو </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="slang-wrap">
                                                <div class="name">پوند </div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="form-element has-icon">
                                        ...
                                        <div class="the-icon">
                                            <select class="category select selectpicker">
                                                    <option value="0">همه رده</option>
                                                    <option value="0">پوشش مردانه</option>
                                                    <option value="0">پوشش زنانه</option>
                                                    <option value="0">پوشش کودکانه</option>
                                  ...
                                  <div class="col-lg-3 col-sm-12">
                                    <div class="mega-menu-columns">
                                        ...
                                        <ul class="menga-menu-page-links">
                                            ...
                                            <li><a href="sellers-products.html">پرفروش ترین ها</a></li>
                        ...
                        <div class="col-lg-6 padding-right-0">
                            <div class="left-content-area signup-bg">
                                <div class="img-wrapper">
                                        <a href="#" class="boxed-btn">ایجاد حساب کاربری</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                                ...
                                <div class="bottom-content">
                                    <form action="#" class="login-form">
                                        <div class="form-element">
                                            <input type="email" class="input-field" placeholder="نام کاربری یا ایمیل خود را وارد کنید">
                                        </div>
                                        <div class="form-element">
                                            <input type="password" class="input-field" placeholder="رمز عبور">
                                        </div>
                                        <div class="block-link">
                                            <a href="#" class="facebook">با فیس بوک وارد شوید</a>
                                            <a href="#" class="google">با + Google وارد شوید</a>
                                        </div>
                                        <div class="btn-wrapper">
                                            <button type="submit" class="submit-btn">ثبت نام</button>
                                            <a href="#" class="link">در حال حاضر حساب کاربری دارید؟</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
        ...
        <div class="footer-top-one blue-bg"><!-- footer top one-->
            <div class="container">
                                ...
                                <ul class="contact-info-list">
                                    <li>
                                        <div class="single-contact-info">
                                            ...
                                            <div class="content">
                                                <span class="details">ایران، ارومیه، ساختمان حافظ، فروشگاه بیگ انیا</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget">
                            <div class="widget-title">
                                <h4 class="title">راهنمای خرید</h4>
                        </div>
                        <div class="widget-body">
                            <ul class="page-list">
                                ...
                                <li><a href="track-orders.html">--  حمل و نقل</a></li>
                                <li><a href="#">--  سفارش من کجاست</a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        <div class="widget-title">
                            <h4 class="title">مشاوره خرید</h4>
                        </div>
                        <div class="widget-body">
                            <ul class="page-list">
                                <li><a href="signup.html">--  اکانت شما</a></li>
                                <li><a href="#">--  اطلاعات</a></li>
                                <li><a href="#">--  آدرس</a></li>
                                <li><a href="#">--  تخفیفات</a></li>
                                <li><a href="#">--  تاریخچه سفارش ها</a></li>
                                <li><a href="track-orders.html">--   رهگیری سفارش</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="footer-widget">
                        ...
                        <div class="widget-body">
                            <ul class="page-list">
                                ...
                                <li><a href="#">--  جستجوی محصولات</a></li>
                                <li><a href="#">--  جستجوی پیشرفته</a></li>
                                <li><a href="about.html">--  درباره ما</a></li>
                                <li><a href="contact.html">--  تماس با ما</a></li>
                                <li><a href="partners.html">--  تامین کنندگان</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="copyright-inner"><!-- copyright inner -->
                        <div class="left-content-area">
                            <span class="copyright-text">کپی رایت@TN_Plugin - 2018 _ فارسی و راست چین فارسی توسط طاهر نصیری</span>
                            </div>
                            <div class="right-content-area">
    ...
    <div class="slide-sidebar-area" id="slide-sidebar-area">
        ...
        <div class="bottom-content"><!-- bottom content -->
            <div class="recent-reviews"><!-- recent reviews -->
                <h4 class="title">پر بازدید های اخیر</h4>
            <div class="single-review-item"><!-- single review item -->
                ...
                <div class="content">
                    ...
                    <span class="posted-by">توسط امیر خان</span>
                </div>
            ...
            <div class="single-review-item"><!-- single review item -->
                ...
                <div class="content">
                    ...
                    <span class="posted-by">توسط طاهر خان</span>
                </div>
            </div><!-- //. single review item -->
            <div class="single-review-item"><!-- single review item -->
                <div class="thumb">
                ...
                <div class="content">
                    <h4 class="title">تی شرت سیاه برک</h4>
                    <ul>
                        <li>
                                <i class="fas fa-star"></i>
                        </li>
                    ...
                    <span class="posted-by">توسط جعفر خان</span>
                </div>
            </div>
            <div class="single-review-item"><!-- single review item -->
                <div class="thumb">
                ...
                <div class="content">
                    ...
                    <span class="posted-by">توسط صیدرا</span>
                </div>
            </div><!-- //. single review item -->
            <div class="single-review-item"><!-- single review item -->
                <div class="thumb">
                ...
                <div class="content">
                    ...
                    <span class="posted-by">توسط مجتبی</span>
                </div>
            </div>
        </div> <!-- //. recent reviews -->
    </div><!-- //. bottom content -->
    ...
    <div class="cart-sidebar-area" id="cart-sidebar-area">
        ...
        <div class="bottom-content"><!-- bottom content -->
            ...
            <div class="single-product-item"><!-- single product item -->
                ...
                <div class="content">
                    <h4 class="title">کفش تیره</h4>
                    <div class="price"><span class="pprice">350.00 تومان</span> <del class="dprice">500.00 تومان</del></div>
